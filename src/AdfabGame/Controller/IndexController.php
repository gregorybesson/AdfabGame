...
namespace AdfabGame\Controller;
...
class IndexController extends AbstractActionController
{
    ...
    /*public function indexAction()
    {
        ...
        $mapper = $this->getServiceLocator()->get('adfabgame_game_mapper');
        ...
        if ($this->zfcUserAuthentication()->hasIdentity()) {
            $mapperLeader = $this->getServiceLocator()->get('adfabgame_leaderboard_mapper');
