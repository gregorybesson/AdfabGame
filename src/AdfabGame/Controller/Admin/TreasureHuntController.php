...
class TreasureHuntController extends AbstractActionController
{
    ...
    public function createTreasureHuntAction()
    {
        ...
        $viewModel->setTemplate('adfab-game/treasure-hunt/treasurehunt');
        ...
        if ($request->isPost()) {
            ...
            $game = $service->create($data, $treasurehunt, 'adfabgame_treasurehunt_form');
            if ($game) {
    ...
    public function areapickerAction()
    {
    	...
    	$viewModel->setTemplate('adfab-game/treasure-hunt/areapicker');
    	return $viewModel;
    }
    ...
    {
    	$viewModel = new ViewModel();
    	$viewModel->setTemplate('adfab-game/treasure-hunt/step');
    	$service = $this->getAdminGameService();
    	$gameId = $this->getEvent()->getRouteMatch()->getParam('gameId');
    	if (!$gameId) {
    		return $this->redirect()->toRoute('zfcadmin/adfabgame/list');
