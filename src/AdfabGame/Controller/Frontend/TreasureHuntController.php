...
use AdfabGame\Entity\TreasureHunt;
...
class TreasureHuntController extends GameController
{
    ...
    public function playAction()
    {
        ...
        if (!$user) {
            ...
            $redirect = urlencode($this->url()->fromRoute('frontend/treasurehunt/play', array('id' => $game->getIdentifier()), array('force_canonical' => true)));
        ...
        if (!$entry) {
            ...
            return $this->redirect()->toUrl($this->url()->fromRoute('frontend/treasurehunt/result',array('id' => $identifier)));
        }
    ...
    public function resultAction()
    {
        ...
        $socialLinkUrl = $this->url()->fromRoute('frontend/treasurehunt', array('id' => $game->getIdentifier()), array('force_canonical' => true)).'?key='.$secretKey;
        // With core shortener helper
        $socialLinkUrl = $this->shortenUrl()->shortenUrl($socialLinkUrl);

        $lastEntry = $sg->getEntryMapper()->findLastInactiveEntryById($game, $user);
        if (!$lastEntry) {
            return $this->redirect()->toUrl($this->url()->fromRoute('frontend/treasurehunt', array('id' => $game->getIdentifier()), array('force_canonical' => true)));
        }
    ...
    {
        if (!$this->gameService) {
            $this->gameService = $this->getServiceLocator()->get('adfabgame_treasurehunt_service');
        }
