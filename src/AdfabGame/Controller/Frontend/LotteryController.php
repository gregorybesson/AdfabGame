...
class LotteryController extends GameController
{
    ...
    public function playAction()
    {
        ...
        if (!$user) {
            ...
            $redirect = urlencode($this->url()->fromRoute('lottery/play', array('id' => $game->getIdentifier()), array('force_canonical' => true)));
        ...
        if (!$entry) {
            ...
            return $this->redirect()->toUrl($this->url()->fromRoute('lottery/result',array('id' => $identifier)));
        }
    ...
    public function resultAction()
    {
        ...
        if (!$lastEntry) {
            return $this->redirect()->toUrl($this->url()->fromRoute('lottery', array('id' => $game->getIdentifier()), array('force_canonical' => true)));
        }
