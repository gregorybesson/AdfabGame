...
use AdfabGame\Entity\PrizeCategoryUser as PrizeCategoryUserEntity;
use AdfabGame\Mapper\PrizeCategoryUser as PrizeCategoryUserMapper;
...
class PrizeCategoryUser extends EventProvider implements ServiceManagerAwareInterface
{
    ...
    public function getPrizeCategoryUserMapper()
    {
        if (null === $this->prizeCategoryUserMapper) {
            $this->prizeCategoryUserMapper = $this->getServiceManager()->get('adfabgame_prizecategoryuser_mapper');
        }
    ...
    public function getPrizeCategoryMapper()
    {
        if (null === $this->prizeCategoryMapper) {
            $this->prizeCategoryMapper = $this->getServiceManager()->get('adfabgame_prizecategory_mapper');
        }
