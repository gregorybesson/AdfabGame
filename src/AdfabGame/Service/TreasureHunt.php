...
class TreasureHunt extends Game implements ServiceManagerAwareInterface
{
    ...
    {
        return new \AdfabGame\Entity\TreasureHunt;
    }
    ...
    public function createStep(array $data)
    {
    	...
    	$step  = new \AdfabGame\Entity\TreasureHuntStep();
    	$form  = $this->getServiceManager()->get('adfabgame_treasurehuntstep_form');
    	$form->bind($step);
    	$form->setData($data);
    ...
    public function getTreasureHuntMapper()
    {
        if (null === $this->treasurehuntMapper) {
            $this->treasurehuntMapper = $this->getServiceManager()->get('adfabgame_treasurehunt_mapper');
        }
    ...
    public function getTreasureHuntStepMapper()
    {
    	if (null === $this->treasureHuntStepMapper) {
    		$this->treasureHuntStepMapper = $this->getServiceManager()->get('adfabgame_treasurehuntstep_mapper');
    	}
