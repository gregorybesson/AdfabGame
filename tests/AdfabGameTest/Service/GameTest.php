...
namespace AdfabGameTest\Service;
...
class GameTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testAllowBonusOnePlayed()
    {
        ...
        $mapper = $this->getMockBuilder('AdfabGame\Mapper\Entry')
    ...
    public function testPlayBonusAllowed()
    {
    	...
    	->expects($this->once())
    	->method('insert')
    	->with($this->isInstanceOf('\AdfabGame\Entity\Entry'))
    	->will($this->returnValue(true));
    ...
    public function testCheckExistingEntryUserAndInactive()
    {
    	...
    	->will($this->returnValue($this->getMock('AdfabGame\Entity\Entry')));
    ...
    public function testPlayExistingEntry()
    {
    	...
    	$this->assertInstanceOf('\AdfabGame\Entity\Entry', $entry);
    }
